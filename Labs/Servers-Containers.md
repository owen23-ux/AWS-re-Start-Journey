...
![Lab Introduction](Servers-Containers/Lambda/intro1.png)

*Figure 1: Lab overview*

![Steps and Objectives](Servers-Containers/Lambda/steps-objectives3.png)

*Figure 2: Lab steps and objectives*

---

## Architecture Diagram

![Architecture Diagram](Servers-Containers/Lambda/diagram2.png)

*Figure 3: Architecture diagram showing the sales analysis report solution*
...
![Create Function](Servers-Containers/Lambda/create-function5.png)

*Figure 4: Creating the Lambda function*
...
![Execution Role](Servers-Containers/Lambda/execution-role6.png)

*Figure 5: Selecting the execution role*
...
![Create Layer](Servers-Containers/Lambda/Creating-layer4.png)

*Figure 6: Creating the PyMySQL library layer*

### Layer Selection

![Add Layer](Servers-Containers/Lambda/add-layers7.png)

*Figure 7: Adding the custom layer to the function*
...
![Upload Code](Servers-Containers/Lambda/upload9.png)

*Figure 8: Uploading the function code package*
...
![Runtime Settings](Servers-Containers/Lambda/run-time8.png)

*Figure 9: Runtime settings configuration*
...
![Edit VPC](Servers-Containers/Lambda/edit-vpc11.png)

*Figure 10: VPC configuration*

### Security Group

![VPC Security Group](Servers-Containers/Lambda/vpc-group12.png)

*Figure 11: Security group selection*
...
![Code Source](Servers-Containers/Lambda/code-source10.png)

*Figure 12: Lambda function Python code*
